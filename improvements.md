...
| 30 | **String Manipulation Suite (`str_split`, `str_join`, `regex`)** | Pending | 3.5 (7×0.5÷1) | Sonnet 3.5 | Gemini 1.5 Pro | Essential for parsing and lexing text, required for self-hosting. Decay 0.5. |
| 32 | **Advanced Control Flow (`while`, `match`)** | Pending | 3.25 (6.5×0.5÷1) | Sonnet 3.5 | Gemini 1.5 Pro | State machines and parsers require `while` loops and pattern matching for tokens. Decay 0.5. |
...
| 33 | **Full File System I/O (`write_file`, `mkdir`)** | Pending | 3.0 (6×0.5÷1) | Sonnet 3.5 | Gemini 1.5 Pro | Necessary for the transpiler to write out generated `.go` files and manage projects. Decay 0.5. |
